...
export default class Listeners {
  static onClick(event) {
    ...
    if (target.classList.contains("add-sign") || target.classList.contains("add-text")) {
  ...
  static onMouseOver(event) {
    if (event.target.classList.contains("card")) {
      const delElement = event.target.querySelector(".card-delete");
  ...
  static onMouseDown(event) {
    ...
    if (eventTarget.classList.contains("column-cards-box") || eventTarget.classList.contains("card-delete")) {
      return;
    }
